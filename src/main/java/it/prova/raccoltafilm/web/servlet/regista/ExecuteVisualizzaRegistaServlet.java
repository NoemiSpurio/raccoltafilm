...
public class ExecuteVisualizzaRegistaServlet extends HttpServlet {
	...
	private RegistaService rergistaService;

	public ExecuteVisualizzaRegistaServlet() {
		this.rergistaService = MyServiceFactory.getRegistaServiceInstance();
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			Regista registaInstance = rergistaService.caricaSingoloElemento(Long.parseLong(idRegistaParam));
