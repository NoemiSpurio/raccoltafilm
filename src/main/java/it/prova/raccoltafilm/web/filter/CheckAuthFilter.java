...
public class CheckAuthFilter implements Filter {
	...
	private static final String[] PROTECTED_URLS = { "/admin/", "/PrepareDeleteRegistaServlet",
			"/ExecuteDeleteRegistaServlet", "/regista/delete.jsp", "/PrepareSearchUtenteServlet",
			"/ExecuteSearchUtenteServlet", "/utente/list.jsp", "/utente/search.jsp" };
